...
import 'createrequest_model.dart';
...
class _CreaterequestWidgetState extends State<CreaterequestWidget> {
  ...
  void initState() {
    ...
    _model.shelternameTextController ??= TextEditingController();
    _model.shelternameFocusNode ??= FocusNode();
                                        ...
                                        children: [
                                          ...
                                          Flexible(
                                            child: Padding(
                                              ...
                                              child: TextFormField(
                                                controller: _model
                                                    .shelternameTextController,
                                                focusNode:
                                                    _model.shelternameFocusNode,
                                                autofocus: true,
                                                autofillHints: const [
                                                  AutofillHints.name
                                                ],
                                                ...
                                                keyboardType:
                                                    TextInputType.name,
                                                validator: _model
                                                    .shelternameTextControllerValidator
                                                    .asValidator(context),
                                                inputFormatters: [
                                        ...
                                        children: [
                                          ...
                                          FlutterFlowDropDown<String>(
                                            ...
                                            options: const [
                                              ...
                                              'Ferns, Mosses',
                                              'Fireweed groundsel',
                                              'Flinders Ranger wattle',
                                              'Flowering gum',
                                              'Forest red gum',
                                              'Fungi',
                                              'Grevillea sp',
                                              'Grey gum',
                                              'Gum topped peppeermint',
                                              'Hakea',
                                              'Hazel pomaderris',
                                              'Japonica (Camellia)',
                                              'Kunzea sp',
                                              ...
                                              'Musk daisy bush',
                                              'Myrtle Beach',
                                              'Narrow leafed grey gum',
                                              'Narrow leaved wattle',
                                              'Narrow-leaved peppermint',
                                              'Native plum',
                                              'Paperbark/tea tree',
                                              'Pine cones',
                                              'Plumbago flowers and leaves',
                                              'Poplar box',
                                              'Prickly tea tree',
                                              'Purple prunus leaves and flower',
                                              'Pussy willow',
                                              'Red box',
                                              'Red flowering gum',
                                              'Red ironbark',
                                              ...
                                              'Yellow Gum (Blue gum, white iron bark)'
                                            ],
                                            width: 168.0,
                                            height: 57.0,
                                            searchHintTextStyle:
